...
function App() {
  ...
  return (
    <>
      ...
      <div className="bg-fixed bg-[url('https://res.cloudinary.com/dc367rgig/image/upload/v1706872093/takeaway_sticker_dm4scg.png')] animate-spin h-[90vh] bg-no-repeat bg-center bg-contain"></div>
