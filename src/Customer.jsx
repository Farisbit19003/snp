      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col md:flex-row justify-around gap-2 p-2">
          ...
          <div className="flex flex-row items-center gap-2">
            ...
            />
            <span className="md:text-xl text-sm font-medium whitespace-nowrap font-serif">
              Online Payment
            </span>
            ...
            />
            <span className="md:text-xl items-center whitespace-nowrap text-sm font-medium font-serif">
              Cash on Delivery (COD)
            </span>
          </div>
        </div>
        <div className="flex flex-row justify-start items-center gap-2 p-2">
          <label className="flex flex-row items-center md:w-1/2 w-full  gap-2">
            <p className="md:text-2xl text-lg whitespace-nowrap  font-medium font-gamb">
              Address:
            </p>
            <textarea
